    ...
    listVideos: function (json, cfg) {
        ...
        if (json.error) {
            ...
            for (var i = 0; i < json.data.items.length; i++) {
                ...
                checkbox.setAttribute('name', 'selectedVideos[]');
                checkbox.setAttribute('value',  'http://www.youtube.com/profile?user=' + entry.uploader  );
                ...
                if (this.cfg.layout == 'thumbnails') {
                    ...
                    li.firstChild.firstChild.firstChild.firstChild.appendChild(checkbox);
                }
                ul.appendChild(li);
            }
            ...
            if (this.cfg.paging == true) {
                ...
                if (json.data.totalItems > (json.data.startIndex + json.data.itemsPerPage)) {
                    ...
                    li.appendChild(a);
                    if (a.addEventListener) {
                        a.addEventListener('click', ytEmbed.Proximo.bind(this, {
                            cfg: cfg
                        }), false);
                    } else if (a.attachEvent) {
                        a.attachEvent('onclick', ytEmbed.Proximo.bind(this, {
                            cfg: cfg
                        }));
                    }
                ...
                if (json.data.startIndex > 1) {
                    ...
                    if (a.addEventListener) {
                        a.addEventListener('click', ytEmbed.Anterior.bind(this, {
                            cfg: cfg
                        }), false);
                    } else if (a.attachEvent) {
                        a.attachEvent('onclick', ytEmbed.Anterior.bind(this, {
                            cfg: cfg
                        }));
                    }
