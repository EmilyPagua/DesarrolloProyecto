...
def likeComentario(request,id_comentario):    
    ...
    outfile.write('E -- Escribiendo replica del comentario...\n')
    outfile.close()
...
def buscarHashtag(request):
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L-- Imprimiendo imagenes relacionadas al hashtag...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
# Cerramos el fichero.
    ...
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L-- Trayendo más fotos...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def EscribirReplicaComentario(request,id_comentario):    
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('E-- Escribiendo Replica de comentarios...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def replicarComentario(request,id_comentario): 
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('E-- Escribiendo comentario...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def comentario_Mio(request):
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L-- Mostrando comentarios...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def misComentarios(request,id_album):
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L--Mostrando comentarios realizados...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def principal_inicio(request):
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L-- Entrando a la cuenta en socialace...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
# Cerramos el fichero.
    ...
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L-- Mostrando muro de noticias...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def registro_usuario(request): 
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L-- Leyendo datos del registro del usuario...\n')
    outfile.close()
    # Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def modificar_usuario(request,id_usuario):    
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L-- Recibiendo peticion de modificacion de usuario...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
# Cerramos el fichero.
    ...
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('E-- Usuario modificado con exito...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def ver_MiPerfil(request,id_usuario):    
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('E--Mostrando perfil de usuario...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def registro_album(request): 
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('E--Creando album del usuario...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def ver_albumes(request):
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L--Mostrando albumes del usuario...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def detalle_album(request,id_album):
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L--Mostrando detalle del album...\n')
    outfile.close()
    # Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
# Cerramos el fichero.
    ...
    if 'elimi' in request.POST:
        outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
        outfile.write('B-- Borrando album del usuario...\n')
        outfile.close()
        # Leemos el contenido para comprobar que ha sobreescrito el contenido.
        infile = open('archivoLogs.txt', 'r')
        print('>>> Escritura de fichero concatenando su contenido.')
...
def detalle_album2(request,id_album):
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L--Mostrando albumes de fotos de amigos...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def ver_notificacion(request):
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L--Mostrando notificaciones...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def notificaciones_aprobadas(request,id_notificacion,id_amigo):
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L--Mostrar notificaciones aceptadas...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def notificaciones_aceptadas(request):
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L--Mostrando todas las notificaciones aceptadas del usuario...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def registro_amigo(request):
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('E--Creando enlace de amistad...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def ver_amigos(request):        
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L--Mostrandos los amigos del usuario...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def ver_usuario(request, nombre):
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('E--Enviando solicitud de amistad del amigo buscado...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def ver_PerfilAmigo(request,id_usuario):    
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L--Mostrando el perfil del amigo del usuario...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
...
def busqueda(request):
    outfile = open('archivoLogs.txt', 'a') # Indicamos el valor 'w'.
    outfile.write('L--Buscando amistades...\n')
    outfile.close()
# Leemos el contenido para comprobar que ha sobreescrito el contenido.
    infile = open('archivoLogs.txt', 'r')
    print('>>> Escritura de fichero concatenando su contenido.')
